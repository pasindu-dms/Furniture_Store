                    ...
                    <form onSubmit={e => onSubmit(e)}>
                        ...
                        <div class="input-box">
                         <span class="details">Gender</span>
                            <select className="form-control" aria-label="Default select example" value ={Gender} onChange={(e)=> onInputChange(e)} >
                       ...
                       <div class="input-box">
                         ...
                         <select className="form-control" aria-label="Default select example" value ={Position} onChange={(e)=> onInputChange(e)} >
